package com.fagneravila.cursomc.resources.exception;
...
public ResponseEntity<StandarError> dataIntegritException(DataIntegrityException e, HttpServletRequest request ){
